...
ScenarioInfo = {
    ...
    starts = true,
    size = {1024, 1024},
    map = '/maps/supreme_risk.v0012/Supreme_Risk.scmap',
    save = '/maps/supreme_risk.v0012/Supreme_Risk_save.lua',
    script = '/maps/supreme_risk.v0012/Supreme_Risk_script.lua',
    norushradius = 2000,
    Configurations = {
        ['standard'] = {
            teams = {
