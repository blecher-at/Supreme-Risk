...
ScenarioInfo = {
    ...
    map = '/maps/supreme_risk_forever.v0002/supreme_risk_forever.scmap',
    save = '/maps/supreme_risk_forever.v0002/supreme_risk_forever_save.lua',
    script = '/maps/supreme_risk_forever.v0002/supreme_risk_forever_script.lua',
    norushradius = 2000,
    Configurations = {
        ['standard'] = {
            teams = {
