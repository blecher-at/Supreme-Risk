...
ScenarioInfo = {
    ...
    starts = true,
    size = {1024, 1024},
    map = '/maps/Supreme_Risk.v0011/Supreme_Risk.scmap',
    save = '/maps/Supreme_Risk.v0011/Supreme_Risk_save.lua',
    script = '/maps/Supreme_Risk.v0011/Supreme_Risk_script.lua',
    norushradius = 2000,
    Configurations = {
        ['standard'] = {
            teams = {
